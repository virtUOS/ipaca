"""
Models for lesson related data.
"""
import json5
...
class Lesson(models.Model):
    ...
    wrapup = models.TextField(null=True)  # text to be displayed after the lesson has been finished
...
class Task(models.Model):
    ...
    interaction: in what way does the Learner give their answer
